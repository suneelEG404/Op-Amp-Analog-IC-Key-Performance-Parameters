...
<head>
<meta charset="UTF-8">
<title>Op-Amp / Analog IC Key Parameters — Complete Notes</title>
<style>
  :root{
    --navy:#1b2a4a;
    --red:#c0392b;
  ...
  *{box-sizing:border-box;}
  ...
  header.title{
    ...
    background:linear-gradient(135deg,var(--navy),#2a4373);
    color:#fff;
    border-radius:14px;
    margin-bottom:34px;
  ...
  .toc h2{margin-top:0;color:var(--navy);font-size:1.05em;letter-spacing:.5px;}
  .toc ol{columns:2;column-gap:30px;margin:0;padding-left:20px;font-size:0.95em;}
  ...
  h2.qtitle{
    ...
    align-items:center;
    margin:0 0 16px;
    border-bottom:2px dashed #eadfae;
    padding-bottom:10px;
  }
  .section-label{
  ...
  .answer{color:var(--blue);margin-bottom:14px;font-size:1.02em;}
  ...
  table.values tr:nth-child(even){background:#f7f5ef;}
  footer{
    text-align:center;
    color:var(--muted);
    font-family:'Segoe UI',sans-serif;
  ...
  .summary-table h2{color:var(--navy);margin-top:0;}
  .summary-table table{width:100%;border-collapse:collapse;font-family:'Segoe UI',sans-serif;font-size:0.88em;}
  .summary-table th{background:var(--red);color:#fff;padding:8px;text-align:left;}
  .summary-table td{padding:8px;border-bottom:1px solid #eee;}
  .summary-table tr:nth-child(even){background:#faf8f0;}
</style>
</head>
<body>
<div class="wrap">
